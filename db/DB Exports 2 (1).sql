...
CREATE TABLE `sub_teacher` (
  ...
  CONSTRAINT `fk_time_schedule_name6` FOREIGN KEY (`fk_time_schedule_name`) REFERENCES `time_schedule` (`time_schedule_name`) ON DELETE SET NULL,
...
INSERT INTO `subject` VALUES (18,'Microprocessor','IV',3,0,1,'..Slot Pref..','CCP Routine 2020'),(19,'Microprocessor Lab','IV',3,1,1,'..Slot Pref..','CCP Routine 2020');
...
INSERT INTO `teacher` VALUES (16,'SH',4,'..Time Matirx..','CCP Routine 2020'),(18,'BR',4,'..Time Matirx..','CCP Routine 2020');
...
INSERT INTO `time_schedule` VALUES ('CCP Routine 2020','CCP','10:30:00',6,30,'susantakumarkhan9733@gmail.com');
...
INSERT INTO `user` VALUES ('susantakumarkhan9733@gmail.com','dadadfa@name=Susanta','undefined');
...
-- Dump completed on 2020-01-13  7:51:21
