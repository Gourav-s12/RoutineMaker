...
CREATE TABLE `sub_teacher` (
  ...
  CONSTRAINT `fk_time_schedule_name6` FOREIGN KEY (`fk_time_schedule_name`) REFERENCES `time_schedule` (`time_schedule_name`) ON DELETE RESTRICT,
...
-- Dump completed on 2020-01-13  2:36:43
