...
function generate() {
            ...
            for(var j = 0;j < son.subAlocation[i].length;j++) {
                if(lib.rand(1,2) == 1) {
                    ...
                    //if(exchangeS != i) {
                        ...
                        // //console.log(son.subAlocation[i][j]);
                        // console.log(sonArr);
                        if(exchangeS == i || exchangeS == null || sub[exchangeS].pos.some((obj)=>{return obj.x == son.subAlocation[i][j].x && obj.y == son.subAlocation[i][j].y}) == true) {
                        if(exchangeS != null)  {
                    ...
                    //if(exchangeD != i) {
                        ...
                        // console.log(daughter.subAlocation[i][j]);
                        if(exchangeD == i || exchangeD == null || sub[exchangeD].pos.some((obj)=>{return obj.x == daughter.subAlocation[i][j].x && obj.y == daughter.subAlocation[i][j].y}) == true) {
                        if(exchangeD != null) {
        ...
        for(var i = 0;i < child.subAlocation.length;i++) {
            for(var j = 0;j < child.subAlocation[i].length;j++) {
                if(lib.rand(1,2) == 1) {
                    ...
                    if(exchange != i && exchange != null && sub[exchange].pos.some((obj)=>{return obj.x == child.subAlocation[i][j].x && obj.y == child.subAlocation[i][j].y}) == false) continue;
                    if(exchange != i) {
                        if(exchange != null) {
    ...
    genetic.evolve({"size":250,"iterations": 1000,"skip":2000,"workersCount":10, "mutation":0.8}, null);
}
